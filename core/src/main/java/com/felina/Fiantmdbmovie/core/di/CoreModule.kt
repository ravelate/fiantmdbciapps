package com.felina.Fiantmdbmovie.core.di

import androidx.room.Room
import com.felina.Fiantmdbmovie.core.data.MovieRepository
import com.felina.Fiantmdbmovie.core.data.source.local.LocalDataSource
import com.felina.Fiantmdbmovie.core.data.source.local.room.MovieDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("fian".toCharArray())
